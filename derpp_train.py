...
CHECKPOINT_DIR = Path(__file__).resolve().parent / "checkpoints_derpp"
...
def main():
    ...
    for task_idx, task in enumerate(task_names):
        ...
        if derpp_buffer_state is not None:
            model.load_derpp_buffer_state(derpp_buffer_state)
        ...
        derpp_buffer_state = model.get_derpp_buffer_state()
    ...
    history_path = CHECKPOINT_DIR / "task_iou_history_derpp.json"
